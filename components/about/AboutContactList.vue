<template>
  <div class="mt-12 md:mt-16">
    ...
    >
      <a href="mailto:corneilleayao@gmail.com" target="_blank">
        <div
      ...
      <a
        href="https://www.linkedin.com/in/ayao-corneille-allogbalo"
        target="_blank"
      >
        <div
          class="h-full flex items-center p-2 rounded-sm hover:shadow-sm slick-border darker-text"
      ...
      <a href="https://twitter.com/CorneilleEdi" target="_blank">
        <div
          class="h-full flex items-center p-2 rounded-sm hover:shadow-sm slick-border darker-text"
        >
          <div
